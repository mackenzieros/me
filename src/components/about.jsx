                            ...
                            <div className="row row-bottom-padded-sm animate-box" data-animate-effect="fadeInLeft">
                                <div className="col-md-12">
                                    <div className="about-desc">
                                        ...
                                        <p>
                                            I am <strong>Mackenzie Ros</strong>, a college graduate from the University of California, Irvine (Zoot zoot). I love learning new things and engaging in the challenges that come with them.
                                        </p>
                                        <p>
